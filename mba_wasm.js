...
* @returns {string}
*/
export function invert_poly(poly, bits, alg) {
    let deferred4_0;
    let deferred4_1;
    try {
        const retptr = wasm.__wbindgen_add_to_stack_pointer(-16);
        const ptr0 = passStringToWasm0(poly, wasm.__wbindgen_malloc, wasm.__wbindgen_realloc);
        const len0 = WASM_VECTOR_LEN;
        const ptr1 = passStringToWasm0(alg, wasm.__wbindgen_malloc, wasm.__wbindgen_realloc);
        const len1 = WASM_VECTOR_LEN;
        wasm.invert_poly(retptr, ptr0, len0, bits, ptr1, len1);
...
* @returns {string}
*/
export function rand_poly(bits) {
    let deferred1_0;
    let deferred1_1;
    try {
        const retptr = wasm.__wbindgen_add_to_stack_pointer(-16);
        wasm.rand_poly(retptr, bits);
        var r0 = getInt32Memory0()[retptr / 4 + 0];
        var r1 = getInt32Memory0()[retptr / 4 + 1];
        deferred1_0 = r0;
        deferred1_1 = r1;
...
export function obfuscate_linear(req) {
    ...
    try {
        ...
        var ptr0 = req.__destroy_into_raw();
...
export class ObfLinReq {
    ...
    */
    get bits() {
        const ret = wasm.__wbg_get_obflinreq_bits(this.__wbg_ptr);
        return ret;
    }
    /**
    * The integer width.
    ...
    */
    set bits(arg0) {
        wasm.__wbg_set_obflinreq_bits(this.__wbg_ptr, arg0);
    }
    /**
    ...
    */
    get randomize() {
        const ret = wasm.__wbg_get_obflinreq_randomize(this.__wbg_ptr);
        return ret !== 0;
    }
    /**
    * Should the solution be randomized.
    ...
    */
    set randomize(arg0) {
        wasm.__wbg_set_obflinreq_randomize(this.__wbg_ptr, arg0);
    }
    /**
    ...
    */
    get printer() {
        const ret = wasm.__wbg_get_obflinreq_printer(this.__wbg_ptr);
        return ret;
    }
    /**
    * How to print the result.
    ...
    */
    set printer(arg0) {
        wasm.__wbg_set_obflinreq_printer(this.__wbg_ptr, arg0);
    }
    /**
    */
    constructor() {
    ...
    */
    set expr(expr) {
        const ptr0 = passStringToWasm0(expr, wasm.__wbindgen_malloc, wasm.__wbindgen_realloc);
        const len0 = WASM_VECTOR_LEN;
        wasm.obflinreq_set_expr(this.__wbg_ptr, ptr0, len0);
    }
    /**
    * @param {string} op
    */
...
export class SolveTrace {
    ...
    static __wrap(ptr) {
        ptr = ptr >>> 0;
        const obj = Object.create(SolveTrace.prototype);
        obj.__wbg_ptr = ptr;
    ...
    free() {
        const ptr = this.__destroy_into_raw();
        wasm.__wbg_solvetrace_free(ptr);
    }
    /**
    * @returns {string}
    */
    get diag() {
        ...
        try {
            const retptr = wasm.__wbindgen_add_to_stack_pointer(-16);
            wasm.solvetrace_diag(retptr, this.__wbg_ptr);
            var r0 = getInt32Memory0()[retptr / 4 + 0];
            var r1 = getInt32Memory0()[retptr / 4 + 1];
            deferred1_0 = r0;
            deferred1_1 = r1;
    ...
    */
    get scalar_system() {
        ...
        try {
            const retptr = wasm.__wbindgen_add_to_stack_pointer(-16);
            wasm.solvetrace_scalar_system(retptr, this.__wbg_ptr);
            var r0 = getInt32Memory0()[retptr / 4 + 0];
            var r1 = getInt32Memory0()[retptr / 4 + 1];
            deferred1_0 = r0;
            deferred1_1 = r1;
    ...
    * @returns {string}
    */
    get linear_solutions() {
        let deferred1_0;
        let deferred1_1;
        try {
            const retptr = wasm.__wbindgen_add_to_stack_pointer(-16);
            wasm.solvetrace_linear_solutions(retptr, this.__wbg_ptr);
            var r0 = getInt32Memory0()[retptr / 4 + 0];
            var r1 = getInt32Memory0()[retptr / 4 + 1];
            deferred1_0 = r0;
            deferred1_1 = r1;
    ...
    */
    get vector_solution() {
        ...
        try {
            const retptr = wasm.__wbindgen_add_to_stack_pointer(-16);
            wasm.solvetrace_vector_solution(retptr, this.__wbg_ptr);
            var r0 = getInt32Memory0()[retptr / 4 + 0];
            var r1 = getInt32Memory0()[retptr / 4 + 1];
            deferred1_0 = r0;
            deferred1_1 = r1;
    ...
    */
    get final_solution() {
        ...
        try {
            const retptr = wasm.__wbindgen_add_to_stack_pointer(-16);
            wasm.solvetrace_final_solution(retptr, this.__wbg_ptr);
            var r0 = getInt32Memory0()[retptr / 4 + 0];
            var r1 = getInt32Memory0()[retptr / 4 + 1];
            deferred1_0 = r0;
            deferred1_1 = r1;
...
async function __wbg_init(input) {
    ...
    if (typeof input === 'undefined') {
        input = new URL('mba_wasm_bg.wasm', import.meta.url);
    }
    const imports = __wbg_get_imports();
